 ...
 */
package ucs.exercise.heritier.core.models;
...
import ucs.exercise.heritier.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "exercise-ucs-heritier/components/helloworld");
